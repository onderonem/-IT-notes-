...
student_id INT PRIMARY KEY, -- student_id ==> it cannot have null value and duplications
student_name VARCHAR(50) NOT NULL, -- student_name cannot have null values
student_age INT,
student_dob DATE UNIQUE -- => No duplications, it can be one NULL or multiple NULL values
);
...
-- we just create records for ssn and address
INSERT INTO people(ssn, address) VALUES(567890123, 'California');
 -- we just create records for ssn and address
INSERT INTO people(ssn, name) VALUES(567890124, 'California');  
-- we just create records for ssn and name
